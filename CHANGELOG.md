...
- Repair GBK mojibake in the package.json description (the U+95B3 U+003F marker pair restored to the arrow/dash of the clean 0.3.0 text) and translate the leftover Chinese appendix/note strings in the EN/ES/PT/HI READMEs; no behavior change.
